...
const $team1Score = document.getElementById("score-India");
const $team1Wickets = document.getElementById("wickets-India");
const $team2Score = document.getElementById("score-Pakistan");
const $team2Wickets = document.getElementById("wickets-Pakistan");
...
if (turn === 2) {
    ...
    document.querySelector(
        `#Pakistan-superover div:nth-child(${team2BallFaced})`
...
if (turn === 1) {
    team1BallFaced++;
    document.querySelector(
        `#India-superover div:nth-child(${team1BallFaced})`
    ).textContent = randomEvents
    if (randomEvents === "W") {
        team1Wickets++;
    }else{
